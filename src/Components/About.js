    ...
    <div>
        <div className='backimg'>
            <div class='text'>
                ...
                <p className='fw-light fs-5 text-black'>
                    Unlock Your Financial Potential with Expert Investment Planning   
                </p>
                <p className='text-black'>
                    Our advisors will craft personalized strategies and recommend the best investment options tailored to your financial goals.<br/>
        ...
        <div>
            <Container>
                <Row>
                    <h2 className='mt-5'>Choosing the Best Investment Planning Service Provider</h2>
                    <Col lg={12}>
                        <p className='fs-6 fw-light text-black' style={{fontFamily:"sans-serif",textAlign:"left",padding:"20px",margin:"20px"}}>
                ...
                <Row>
                    <h2 className='mt-5 p-3'>What is SIP Investment? A Smart Way to Grow Your Wealth</h2>
                    <Col lg={6}>
                        <img className='d-block w-100' src={fimage} alt=' ' />
                    </Col>
                    <Col lg={6}>
                        <p className='fs-6 fw-light text-black' style={{fontFamily:"sans-serif",textAlign:"left",padding:"20px",margin:"20px"}}>
